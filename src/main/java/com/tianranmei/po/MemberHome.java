...
public class MemberHome {
	...
	public Member merge(Member detachedInstance) {
		...
		try {
			Member result = (Member) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Member findById(java.lang.Integer id) {
		...
		try {
			Member instance = (Member) sessionFactory.getCurrentSession().get("com.tianranmei.po.Member", id);
			if (instance == null) {
	...
	public List findByExample(Member instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.tianranmei.po.Member")
